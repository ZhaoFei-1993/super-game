...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        for quiz in Quiz.objects.filter(category__parent_id=2):
            ...
            host_avatar = quiz.host_team_avatar.replace(MEDIA_DOMAIN_HOST + '/images/spider/football/team_icon/', '')
            guest_avatar = quiz.guest_team_avatar.replace(MEDIA_DOMAIN_HOST + '/images/spider/football/team_icon/', '')
