...
class Command(BaseCommand):
    ...
    eos_monitor_url = 'https://api.eospark.com/api?module=account&action=get_account_related_trx_info&apikey=' + settings.EOS_SPARK_API_KEY + '&account=' + settings.EOS_RECHARGE_ADDRESS + '&page=1&size=100&symbol=EOS&code=eosio.token'
