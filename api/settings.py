...
PROMOTER_EXCHANGE_START_DATE = local_settings.PROMOTER_EXCHANGE_START_DATE
...
# 发送警报邮件配置
IS_ENABLE_EMAIL_ALERT = local_settings.IS_ENABLE_EMAIL_ALERT
...
EMAIL_RECIPIENT_LIST = local_settings.EMAIL_RECIPIENT_LIST
