    ...
    if len(datas['data']) != 0:
        for data in list(datas['data'].items()):
            ...
            if option_data_had:
                ...
                flag_d_had = 'd'
                flag_h_had = 'h'
                result_had = [(flag_h_had, title_h_had, odd_h_had), (flag_d_had, title_d_had, odd_d_had), (flag_a_had, title_a_had, odd_a_had)]
            ...
            if option_data_hhad:
                ...
                flag_d_hhad = 'd'
                flag_h_hhad = 'h'
                result_hhad = [(flag_h_hhad, title_h_hhad, odd_h_hhad), (flag_d_hhad, title_d_hhad, odd_d_hhad), (flag_a_hhad, title_a_hhad, odd_a_hhad)]
                        ...
                        if len(re.findall('http://static.sporttery.(cn|com)/(.*)', host_team_img_url)) > 0 and \
                            ...
                            host_team_avatar = \
                                re.findall('http://static.sporttery.(cn|com)/(.*)', host_team_img_url)[0][1].replace(
                                    ...
                                    '_')
                            guest_team_avatar = \
                                re.findall('http://static.sporttery.(cn|com)/(.*)', guest_team_img_url)[0][1].replace(
                                    '/', '_')
