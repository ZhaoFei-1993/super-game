...
class Command(BaseCommand):
    ...
    def on_message(ws, message):
        ...
        if status is False:
            table_info = Table.objects.get(three_table_id=3)
                        ...
                        if answer_pair == 100:
                            ...
                            if record.option.id == 7 or record.option.id == 8:
                                ...
                                q.enqueue(baccarat_lottery, record.user_id, coins, number_tab.opening,
                                          number_tab.pair, balance, record.club.coin.name, record.club.id)
                                print("-----------庄和/闲和 开奖推送完成--------------")
                        else:
                            print("----------------------------开庄闲------------------------------")
    ...
    @staticmethod
    def on_open(ws):
        get_token = Table.objects.get_token(three_table_id=3)
